...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Dispatcher Form</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ url('/users/list') }}">Users List</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-body -->
                <form method="POST" action="{{ $data->id ? url('users/'.$data->id) : url('users/store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="{{ old('phone', $data->phone) }}" id="phone" name="phone" placeholder="Enter dispatcer phone" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" value="{{ old('email', $data->email) }}" id="email" name="email" placeholder="Enter customer email..." required>
                                </div>
                            </div>
                        </div>

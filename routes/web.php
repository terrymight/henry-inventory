...
Route::get('customer/show/{id}', [App\Http\Controllers\CustomersController::class,'show'])->middleware(['auth','admin'])->name('customers.notify');
...
Route::delete('state/destroy/{id}', [App\Http\Controllers\StateController::class,'destroy'])->middleware(['auth','admin'])->name('state.destroy');
...
Route::delete('users/destroy/{id}', [App\Http\Controllers\UserController::class,'destroy'])->middleware(['auth','admin'])->name('users.destroy');
...
Route::delete('staff/destroy/{id}', [App\Http\Controllers\StaffController::class,'destroy'])->middleware(['auth','admin'])->name('staff.destroy');
